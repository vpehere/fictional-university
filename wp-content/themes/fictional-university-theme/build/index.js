...
class Search {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("keyup", this.keyPressedDispatcher.bind(this));
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().when(jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-jsonaaa/wp/v2/posts?search=' + this.searchField.val()), jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-json/wp/v2/pages?search=' + this.searchField.val())).then((posts, pages) => {
      var combineResults = posts[0].concat(pages[0]);
      this.resultsDiv.html(`
                <h2 class="search-overlay__section-title">General Information</h2>
                    ${combineResults.length ? '<ul class="link-list min-list">' : 'No information found'}
            ...
            <div class="search-overlay">
                <div class="search-overlay__top">
                    <div class="container">
                        ...
                        <input type="text" class="search-term" placeholder="What you are looking for?" id = "search-term" autocomplete="off">
